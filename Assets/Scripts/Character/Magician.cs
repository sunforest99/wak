...
public class Magician : Character
{
    ...
    public override void attack(Vector2 attackDir, bool isMe = false)
    {
        ...
        attObj = Instantiate(GameMng.I.magicianSkillPrefab[0], spawnPos, Quaternion.Euler(90, 0, lookAngle)) as GameObject;
    ...
    public override void skill_4(Vector2 skillPos, bool isMe = false)
    {
        ...
        attObj =  Instantiate(GameMng.I.magicianSkillPrefab[3], new Vector3(skillPos.x, -0.18f, skillPos.y), Quaternion.Euler(90, 0, 0)) as GameObject;
        if (isMe) {
            attObj.tag = "Skill";
            attObj.name = "3";
        }
    ...
    public override void skill_5(Vector2 skillPos, bool isMe = false)
    {
        ...
        attObj =  Instantiate(GameMng.I.magicianSkillPrefab[4], new Vector3(skillPos.x, 0, skillPos.y), Quaternion.Euler(20, 0, 0)) as GameObject;
        if (isMe) {
            attObj.tag = "Skill";
            attObj.name = "4";
        }
